...
class ThreadPoolExecutor04 {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        System.out.println("active: " + executorService.getActiveCount()); // 0, 线程池启动后，默认不会创建任何线程
        executorService.setMaximumPoolSize(10); // key
        ...
        System.out.println("last-active: " + executorService.getActiveCount());
    }
}
